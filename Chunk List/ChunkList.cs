/*
   ...
   Copyright {2017} {Daniel Szelogowski}
...
namespace Chunk_List
{
    class ChunkList<T> where T : IComparable
    {
        ...
        /// <summary>
        /// Converts the specified index to which chunk the index would be located
        /// </summary>
        ...
        /// <summary>
        /// Converts the specified index to the position inside of the chunk
        /// </summary>
        /// <param name="index">Index to convert</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Creates a new Chunk List with the default chunk size (1000 elements)
        /// <para />
        /// Method headers contain Big-O time, with variable "c" being chunks currently in the list, "i" being the specified index, "p" being the number of processors, and "n" being the number of elements per chunk.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new Chunk List with the specified chunk size
        /// <para />
        /// Method headers contain Big-O time, with variable "c" being chunks currently in the list, "i" being the specified index, "p" being the number of processors, and "n" being the number of elements per chunk.
        /// </summary>
        /// <param name="chunkSize">Amount of elements each chunk will hold</param>
        ...
        /// <para />
        /// Average Case: Big-O ((log c * n) / p)
        /// <para />
        /// Worst Case: Big-O (log c * n)
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="t">Item to be removed</param>
        ...
        public void removeAt(int index)
        {
            ...
            try
            {
                myList[convertIndexToChunk(index)].RemoveAt(convertIndexToChunkPos(index));
            }
        ...
        /// <summary>
        /// Set specified item at specified index in list
        /// <para />
        /// Average Case: Big-O (1)
        /// <para />
        /// Worst Case: Big-O (c * n - i)
        ...
        /// <typeparam name="T"></typeparam>
        /// <param name="t">Item to be set</param>
        public void set(int index, T t)
        {
            if (index >= size()) throw new ArgumentOutOfRangeException();
            try
            {
                myList[convertIndexToChunk(index)][convertIndexToChunkPos(index)] = t;
            }
            catch (ArgumentOutOfRangeException)
            {
                set(index + 1, t);
        ...
        /// <summary>
        /// Returns a list of all items in the chunk list
        /// <para />
        /// Big-O (c ^ 2 * n)
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Checks each thread in parallel to see if list contains the specified item
        /// <para />
        /// Average Case: Big-O ((log c * log n) / p)
        /// <para />
        /// Worst Case: Big-O (c * n)
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="t">Item to be searched for</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Clears the list and erases all chunks
        /// <para />
        /// Big-O (1)
        /// </summary>
        public void clear()
        ...
        /// <summary>
        /// Returns the amount of elements of all chunks combined 
        /// <para />
        /// Big-O (c)
        /// </summary>
        /// <returns></returns>
        ...
        /// Best Case: Big-O (1)
        /// <para />
        /// Worst Case: Big-O (c ^ 2 * n)
        /// </summary>
        /// <param name="newChunkSize">Amount of elements each chunk will hold</param>
        ...
        /// <summary>
        /// Get current chunk size for list
        /// <para />
        /// Big-O (1)
        /// </summary>
        /// <returns></returns>
        ...
        /// <para />
        /// Average Case: Big-O (c * n * log n)
        /// <para />
        /// Worst Case: Big-O (c * n ^ 2)
        /// </summary>
        public void sort()
        {
            var items = getList();
